...
function draw() {
  ...
  text("You Have To Drag The Mouse and Release It, After That The polygon ",300,30);
  text("(Hexagon) Will Launch :)",298,60);
  text("If You Want To Launch The Polygon Again ,Then Press SPACE KEY,",296,100);
  text("Then It Will Reset To Its Position Again. And Then You Can :)",294,130);
